...
const PROJECTS = [
  ...
  },
  {
    ...
    stack: ['React', 'TypeScript', 'FastAPI', 'Python', 'PostgreSQL', 'Claude AI'],
    color: 'purple',
    summary: 'Full-stack financial planner for international students featuring ML-powered spending forecasts, 45+ currency support, visa compliance tracking, and an AI chat assistant.',
    metrics: ['45+ currencies', 'ML forecasting (Chronos-2 + Prophet)', 'Deployed on Vercel + Render'],
    description: [
      'Built a full-stack financial planner for international students — transaction management with 45+ currency support via live exchange rates, budget tracking with real-time alerts, savings goals, and F-1/J-1 visa-compliant work-hour monitoring.',
      'Engineered a three-tier ML forecasting pipeline: Amazon Chronos-2 (T5 transformer) as primary, Meta Prophet as secondary, and statistical exponential smoothing as fallback — trained on 17 covariates including rent, tuition, scholarships, and exchange rates.',
      'Integrated a Claude AI chat assistant for natural language financial commands, LLM-assisted CSV/Excel import with automatic category detection, and a what-if scenario planner for hypothetical transaction modeling.',
      'React 19 + TypeScript frontend with FastAPI + PostgreSQL backend; Google OAuth authentication, Cloudflare R2 file storage for receipts and avatars, and split deployment architecture across Vercel and Render.',
    ],
    github: 'https://github.com/janyajaiswal/Spendemic',
    demo: 'https://spendemic-rosy.vercel.app',
  },
  {
    name: 'Doc-Aid',
